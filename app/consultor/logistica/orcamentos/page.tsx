...
export default function OrcamentosLogisticaPage() {
  ...
  const handleAddOrcamento = () => {
    if (veiculos.length === 0) return alert('Cadastre um veículo primeiro!');
  ...
  const handleDelete = (id: string) => {
    if(confirm('Tem certeza?')) logisticaStore.deleteOrcamento(id);
  };
